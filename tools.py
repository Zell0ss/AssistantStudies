...
def get_tools():
    """
    Returns a list of core tools for the agent to use.

    Note: Weather tools (WeatherSummary, WeatherReport) are now provided by the
    weather provider and are added separately via ProviderRegistry.get_all_tools()
